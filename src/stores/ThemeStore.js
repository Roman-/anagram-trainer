...
// local storage keys
const isDarkKey = "anagrams_theme.is_dark";
const darkNameKey = "anagrams_theme.dark_name";
const lightNameKey = "anagrams_theme.light_name";

// defaults
const defaultIsDark = false;
const defaultLightName = "zephyr";
const defaultDarkName = "superhero";
